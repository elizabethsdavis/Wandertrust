...
import { Search, Plus, Check, ChevronRight, Plane, Sparkles, ArrowLeft, X, AlertTriangle, Clock, PackageCheck, Zap, RotateCcw, Trash2, Copy, Award, TrendingUp, Brain, BarChart3, Timer, Shield, RefreshCw, Thermometer, Wind, CloudRain, Umbrella, Heart, Eye, Star, Loader } from "lucide-react";
      ...
      <div style={{ minHeight: "100vh", background: C.cream }}>
        ...
        <div style={{ background: `linear-gradient(135deg,${C.warmWhite},${C.cream})`, padding: "20px 24px 24px",
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 20, flexWrap: "wrap" }}>
            <Btn v="primary" sz="sm" onClick={() => setGuidedMode(true)} style={{ flex: 1 }}>
              <Zap size={15} /> Focus Pack
            </Btn>
            <Btn v="lavender" sz="sm" onClick={() => setFreakOut(true)} style={{ flex: 1 }}>
              <Brain size={15} /> Freak Out Mode
            </Btn>
          </div>
